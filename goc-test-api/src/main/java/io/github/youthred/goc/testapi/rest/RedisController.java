...
public class RedisController {
    ...
    public void save() {
        ...
        redisTemplate.opsForHash().putAll(RedisConstant.GOC_AUTH_PERMISSION_MAP + ":" + HttpMethod.GET.name(), resourceRolesMap);
        redisTemplate.opsForHash().putAll(RedisConstant.GOC_AUTH_PERMISSION_MAP + ":" + HttpMethod.POST.name(), resourceRolesMap);
    }
}
